    ...
    eventBind:function () {
        ...
        $(".wrap_cat_set .save").click(function(){
                ...
                if (parseInt(weight) < 1){
                    common_ops.tip("请输入符合规范的权重，至少>1", mobile_target);
                    return false;
                }
                ...
                $.ajax({
                    url:common_ops.buildUrl("/quant/cat-set"),
                    type:'POST',
                    data:data,
                    dataType:'json',
                    success:function (res) {
                        ...
                        if (res.code == 200){
                            callback = function () {
                                window.location.href = common_ops.buildUrl("/quant/cat");
                            }
                        }
